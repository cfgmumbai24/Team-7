...
import ToggleButton from './clickme';
      ...
      <div className="file-grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {userFiles.map((fileName) => (
          ...
          >
            ...
            <ToggleButton className="open bg-blue-900 hover:bg-blue-800 text-gray-300 font-semibold py-2 px-4 rounded-lg transition duration-300 ease-in-out border border-blue-800 hover:border-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-700"/>
          </div>
        ))}
      </div>
    </div>
