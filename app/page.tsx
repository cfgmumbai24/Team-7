...
export default function Component() {
  ...
  const AITutorTagline = () => {
    ...
    const fullTagline = 'Smart Platform to help rural people with real-time personalized response and  learning experience for financial literacy';
          ...
          <div className="mx-auto max-w-sm bg-white rounded-lg shadow-md p-6 space-y-6"> 
            ...
            <form onSubmit={handleEmailSignIn} className="space-y-2">
              <div className="space-y-2">
                <Label htmlFor="email" className="text-gray-900">Phone Number</Label>
                <Input id="email" placeholder="Phone number" required type="email" onChange={(event) => setEmail(event.target.value)}/>
              </div>
              <div className="space-y-2">
